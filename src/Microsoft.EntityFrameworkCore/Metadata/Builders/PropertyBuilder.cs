...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
    ...
    public class PropertyBuilder : IInfrastructure<IMutableModel>, IInfrastructure<InternalPropertyBuilder>
    {
        ...
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
        /// <remarks>
        ///     Note that values may still be generated by a client-side value generator.
        /// </remarks>
        ...
        /// <summary>
        ///     Configures a property to have a value generated by the database only when saving a new entity, unless a non-null,
        ///     non-temporary value has been set or generated by a client-side value generator, in which case the set value will be
        ///     saved instead.
        /// </summary>
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
        ...
        /// <summary>
        ///     Configures a property to have a value generated by the database when saving a new or existing entity, unless
        ///     a non-null, non-temporary value has been set or generated by a client-side value generator for a new entity,
        ///     or the existing property value has been modified for an existing entity, in which case the set value will be saved instead.
        /// </summary>
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
